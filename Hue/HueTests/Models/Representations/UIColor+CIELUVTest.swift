...
class UIColor_CIELUVTest: XCTestCase {
    ...
    func testCIELUVInit() {
        assert(UIColor(Luv: CIELUV(L: 100.00000, u: 0.00000, v: 0.00000)), .white)
        assert(UIColor(Luv: CIELUV(L: 53.24079, u: 175.01503, v: 37.75643)), .red)
        assert(UIColor(Luv: CIELUV(L: 87.73472, u: -83.07756, v: 107.39854)), .green)
        assert(UIColor(Luv: CIELUV(L: 32.29701, u: -9.40540, v: -130.34235)), .blue)
        assert(UIColor(Luv: CIELUV(L: 91.11322, u: -70.47734, v: -15.20423)), .cyan)
        assert(UIColor(Luv: CIELUV(L: 60.32421, u: 84.07140, v: -108.68334)), .magenta)
        assert(UIColor(Luv: CIELUV(L: 97.13927, u: 7.70561, v: 106.78663)), .yellow)
        assert(UIColor(Luv: CIELUV(L: 0.00000, u: 0.00000, v: 0.00000)), .black)
        assert(UIColor(Luv: CIELUV(L: 36.14585, u: 0.00000, v: 0.00000)), .darkGray)
        assert(UIColor(Luv: CIELUV(L: 53.38897, u: 0.00000, v: 0.00000)), .gray)
        assert(UIColor(Luv: CIELUV(L: 69.61017, u: 0.00000, v: 0.00000)), .lightGray)
        assert(UIColor(Luv: CIELUV(L: 0.00000, u: 0.00000, v: 0.00000), alpha: 0.0), .clear)
    }
