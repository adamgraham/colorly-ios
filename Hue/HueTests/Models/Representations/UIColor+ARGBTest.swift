...
class UIColor_ARGBTest: XCTestCase {
    ...
    func testARGBInit() {
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 255.0, green: 255.0, blue: 255.0)), .white)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 255.0, green: 0.0, blue: 0.0)), .red)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 0.0, green: 255.0, blue: 0.0)), .green)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 0.0, green: 0.0, blue: 255.0)), .blue)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 0.0, green: 255.0, blue: 255.0)), .cyan)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 255.0, green: 0.0, blue: 255.0)), .magenta)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 255.0, green: 255.0, blue: 0.0)), .yellow)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 0.0, green: 0.0, blue: 0.0)), .black)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 85.0, green: 85.0, blue: 85.0)), .darkGray)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 127.5, green: 127.5, blue: 127.5)), .gray)
        XCTAssertEqual(UIColor(ARGB(alpha: 255.0, red: 170.0, green: 170.0, blue: 170.0)), .lightGray)
        XCTAssertEqual(UIColor(ARGB(alpha: 0.0, red: 0.0, green: 0.0, blue: 0.0)), .clear)
    }
