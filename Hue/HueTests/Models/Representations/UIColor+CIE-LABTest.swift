...
class UIColor_CIE_LABTest: XCTestCase {
    ...
    func testLAB() {
        assert(UIColor.white.lab, LAB(L: 100.00000, a: 0.00000, b: 0.00000))
        ...
        assert(UIColor.black.lab, LAB(L: 0.00000, a: 0.00000, b: 0.00000))
        assert(UIColor.darkGray.lab, LAB(L: 36.14585, a: 0.00000, b: 0.00000))
        assert(UIColor.gray.lab, LAB(L: 53.38897, a: 0.00000, b: 0.00000))
        assert(UIColor.lightGray.lab, LAB(L: 69.61017, a: 0.00000, b: 0.00000))
        assert(UIColor.clear.lab, LAB(L: 0.00000, a: 0.00000, b: 0.00000))
    }

    func testLABInit() {
        assert(UIColor(lab: LAB(L: 100.00000, a: 0.00000, b: 0.00000)), .white)
        ...
        assert(UIColor(lab: LAB(L: 0.00000, a: 0.00000, b: 0.00000)), .black)
        assert(UIColor(lab: LAB(L: 36.14585, a: 0.00000, b: 0.00000)), .darkGray)
        assert(UIColor(lab: LAB(L: 53.38897, a: 0.00000, b: 0.00000)), .gray)
        assert(UIColor(lab: LAB(L: 69.61017, a: 0.00000, b: 0.00000)), .lightGray)
        assert(UIColor(lab: LAB(L: 0.00000, a: 0.00000, b: 0.00000), alpha: 0.0), .clear)
    }
