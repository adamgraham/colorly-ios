...
class UIColor_CIEXYZTest: XCTestCase {
    ...
    func testCIEXYZInit() {
        assert(UIColor(CIEXYZ(X: 95.04700, Y: 100.00000, Z: 108.88300)), .white)
        assert(UIColor(CIEXYZ(X: 41.24564, Y: 21.26729, Z: 1.93339)), .red)
        assert(UIColor(CIEXYZ(X: 35.75761, Y: 71.51522, Z: 11.91920)), .green)
        assert(UIColor(CIEXYZ(X: 18.04375, Y: 7.21750, Z: 95.03041)), .blue)
        assert(UIColor(CIEXYZ(X: 53.80136, Y: 78.73272, Z: 106.94961)), .cyan)
        assert(UIColor(CIEXYZ(X: 59.28939, Y: 28.48479, Z: 96.96380)), .magenta)
        assert(UIColor(CIEXYZ(X: 77.00325, Y: 92.78251, Z: 13.85259)), .yellow)
        assert(UIColor(CIEXYZ(X: 0.00000, Y: 0.00000, Z: 0.00000)), .black)
        assert(UIColor(CIEXYZ(X: 8.63423, Y: 9.08417, Z: 9.89112)), .darkGray)
        assert(UIColor(CIEXYZ(X: 20.34397, Y: 21.40412, Z: 23.30544)), .gray)
        assert(UIColor(CIEXYZ(X: 38.20678, Y: 40.19778, Z: 43.76855)), .lightGray)
        assert(UIColor(CIEXYZ(X: 0.00000, Y: 0.00000, Z: 0.00000), alpha: 0.0), .clear)
    }
