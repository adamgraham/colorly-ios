...
class UIColor_CIELChTest: XCTestCase {
    ...
    func testCIELCh_ab_Init() {
        assert(UIColor(LCh_ab: CIELCh(L: 100.00000, C: 0.00000, h: 0.00000)), .white)
        assert(UIColor(LCh_ab: CIELCh(L: 53.24079, C: 104.55177, h: 39.99901)), .red)
        assert(UIColor(LCh_ab: CIELCh(L: 87.73472, C: 119.77587, h: 136.01595)), .green)
        assert(UIColor(LCh_ab: CIELCh(L: 32.29701, C: 133.80761, h: 306.28494)), .blue)
        assert(UIColor(LCh_ab: CIELCh(L: 91.11322, C: 50.12086, h: 196.37616)), .cyan)
        assert(UIColor(LCh_ab: CIELCh(L: 60.32421, C: 115.54067, h: 328.23496)), .magenta)
        assert(UIColor(LCh_ab: CIELCh(L: 97.13927, C: 96.90538, h: 102.85124)), .yellow)
        assert(UIColor(LCh_ab: CIELCh(L: 0.00000, C: 0.00000, h: 0.00000)), .black)
        assert(UIColor(LCh_ab: CIELCh(L: 36.14585, C: 0.00000, h: 0.00000)), .darkGray)
        assert(UIColor(LCh_ab: CIELCh(L: 53.38897, C: 0.00000, h: 0.00000)), .gray)
        assert(UIColor(LCh_ab: CIELCh(L: 69.61017, C: 0.00000, h: 0.00000)), .lightGray)
        assert(UIColor(LCh_ab: CIELCh(L: 0.00000, C: 0.00000, h: 0.00000), alpha: 0.0), .clear)
    }
    ...
    func testCIELCh_uv_Init() {
        assert(UIColor(LCh_uv: CIELCh(L: 100.00000, C: 0.00000, h: 247.099)), .white)
        assert(UIColor(LCh_uv: CIELCh(L: 53.24079, C: 179.04136, h: 12.17399)), .red)
        assert(UIColor(LCh_uv: CIELCh(L: 87.73472, C: 135.78044, h: 127.72355)), .green)
        assert(UIColor(LCh_uv: CIELCh(L: 32.29701, C: 130.68125, h: 265.87273)), .blue)
        assert(UIColor(LCh_uv: CIELCh(L: 91.11322, C: 72.09871, h: 192.17397)), .cyan)
        assert(UIColor(LCh_uv: CIELCh(L: 60.32421, C: 137.40476, h: 307.72355)), .magenta)
        assert(UIColor(LCh_uv: CIELCh(L: 97.13927, C: 107.06428, h: 85.87275)), .yellow)
        assert(UIColor(LCh_uv: CIELCh(L: 0.00000, C: 0.00000, h: 0.00000)), .black)
        assert(UIColor(LCh_uv: CIELCh(L: 36.14585, C: 0.00000, h: 0.00000)), .darkGray)
        assert(UIColor(LCh_uv: CIELCh(L: 53.38897, C: 0.00000, h: 0.00000)), .gray)
        assert(UIColor(LCh_uv: CIELCh(L: 69.61017, C: 0.00000, h: 0.00000)), .lightGray)
        assert(UIColor(LCh_uv: CIELCh(L: 0.00000, C: 0.00000, h: 0.00000), alpha: 0.0), .clear)
    }
