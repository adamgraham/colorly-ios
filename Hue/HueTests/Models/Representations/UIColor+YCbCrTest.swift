...
class UIColor_YCbCrTest: XCTestCase {
    ...
    func testYCbCrStandard() {
        ...
        assert(UIColor.red.yCbCr, YCbCr(Y: 0.299, Cb: -0.169, Cr: 0.5, encoding: .standard))
        assert(UIColor.green.yCbCr, YCbCr(Y: 0.587, Cb: -0.331, Cr: -0.419, encoding: .standard))
        assert(UIColor.blue.yCbCr, YCbCr(Y: 0.114, Cb: 0.5, Cr: -0.081, encoding: .standard))
        assert(UIColor.cyan.yCbCr, YCbCr(Y: 0.701, Cb: 0.169, Cr: -0.5, encoding: .standard))
        assert(UIColor.magenta.yCbCr, YCbCr(Y: 0.413, Cb: 0.331, Cr: 0.419, encoding: .standard))
        assert(UIColor.yellow.yCbCr, YCbCr(Y: 0.886, Cb: -0.5, Cr: 0.081, encoding: .standard))
        assert(UIColor.black.yCbCr, YCbCr(Y: 0.0, Cb: 0.0, Cr: 0.0, encoding: .standard))
        assert(UIColor.darkGray.yCbCr, YCbCr(Y: 1.0/3.0, Cb: 0.0, Cr: 0.0, encoding: .standard))
        assert(UIColor.gray.yCbCr, YCbCr(Y: 0.5, Cb: 0.0, Cr: 0.0, encoding: .standard))
        assert(UIColor.lightGray.yCbCr, YCbCr(Y: 2.0/3.0, Cb: 0.0, Cr: 0.0, encoding: .standard))
        assert(UIColor.clear.yCbCr, YCbCr(Y: 0.0, Cb: 0.0, Cr: 0.0, encoding: .standard))
    }
    ...
    func testYCbCrHDTV() {
        assert(UIColor.white.yCbCr(.hdtv), YCbCr(Y: 1.0, Cb: 0.0, Cr: 0.0, encoding: .hdtv))
        assert(UIColor.red.yCbCr(.hdtv), YCbCr(Y: 0.213, Cb: -0.115, Cr: 0.5, encoding: .hdtv))
        assert(UIColor.green.yCbCr(.hdtv), YCbCr(Y: 0.715, Cb: -0.385, Cr: -0.454, encoding: .hdtv))
        assert(UIColor.blue.yCbCr(.hdtv), YCbCr(Y: 0.072, Cb: 0.5, Cr: -0.046, encoding: .hdtv))
        assert(UIColor.cyan.yCbCr(.hdtv), YCbCr(Y: 0.787, Cb: 0.115, Cr: -0.5, encoding: .hdtv))
        assert(UIColor.magenta.yCbCr(.hdtv), YCbCr(Y: 0.285, Cb: 0.385, Cr: 0.454, encoding: .hdtv))
        assert(UIColor.yellow.yCbCr(.hdtv), YCbCr(Y: 0.928, Cb: -0.5, Cr: 0.046, encoding: .hdtv))
        assert(UIColor.black.yCbCr(.hdtv), YCbCr(Y: 0.0, Cb: 0.0, Cr: 0.0, encoding: .hdtv))
        assert(UIColor.darkGray.yCbCr(.hdtv), YCbCr(Y: 1.0/3.0, Cb: 0.0, Cr: 0.0, encoding: .hdtv))
        assert(UIColor.gray.yCbCr(.hdtv), YCbCr(Y: 0.5, Cb: 0.0, Cr: 0.0, encoding: .hdtv))
        assert(UIColor.lightGray.yCbCr(.hdtv), YCbCr(Y: 2.0/3.0, Cb: 0.0, Cr: 0.0, encoding: .hdtv))
        assert(UIColor.clear.yCbCr(.hdtv), YCbCr(Y: 0.0, Cb: 0.0, Cr: 0.0, encoding: .hdtv))
    }
    ...
    private func assert(_ yCbCr: YCbCr, _ expected: YCbCr) {
        ...
        XCTAssertEqual(yCbCr.encoding, expected.encoding)
    }
