...
class UIColor_CIE_XYZTest: XCTestCase {
    ...
    func testXYZ() {
        assert(UIColor.white.XYZ, XYZ(X: 95.04700, Y: 100.00000, Z: 108.88300))
        assert(UIColor.red.XYZ, XYZ(X: 41.24564, Y: 21.26729, Z: 1.93339))
        assert(UIColor.green.XYZ, XYZ(X: 35.75761, Y: 71.51522, Z: 11.91920))
        assert(UIColor.blue.XYZ, XYZ(X: 18.04375, Y: 7.21750, Z: 95.03041))
        assert(UIColor.cyan.XYZ, XYZ(X: 53.80136, Y: 78.73272, Z: 106.94961))
        assert(UIColor.magenta.XYZ, XYZ(X: 59.28939, Y: 28.48479, Z: 96.96380))
        assert(UIColor.yellow.XYZ, XYZ(X: 77.00325, Y: 92.78251, Z: 13.85259))
        assert(UIColor.black.XYZ, XYZ(X: 0.00000, Y: 0.00000, Z: 0.00000))
        ...
        assert(UIColor.clear.XYZ, XYZ(X: 0.00000, Y: 0.00000, Z: 0.00000))
    }

    func testXYZInit() {
        assert(UIColor(XYZ: XYZ(X: 95.04700, Y: 100.00000, Z: 108.88300)), .white)
        assert(UIColor(XYZ: XYZ(X: 41.24564, Y: 21.26729, Z: 1.93339)), .red)
        assert(UIColor(XYZ: XYZ(X: 35.75761, Y: 71.51522, Z: 11.91920)), .green)
        assert(UIColor(XYZ: XYZ(X: 18.04375, Y: 7.21750, Z: 95.03041)), .blue)
        assert(UIColor(XYZ: XYZ(X: 53.80136, Y: 78.73272, Z: 106.94961)), .cyan)
        assert(UIColor(XYZ: XYZ(X: 59.28939, Y: 28.48479, Z: 96.96380)), .magenta)
        assert(UIColor(XYZ: XYZ(X: 77.00325, Y: 92.78251, Z: 13.85259)), .yellow)
        assert(UIColor(XYZ: XYZ(X: 0.00000, Y: 0.00000, Z: 0.00000)), .black)
        ...
        assert(UIColor(XYZ: XYZ(X: 0.00000, Y: 0.00000, Z: 0.00000), alpha: 0.0), .clear)
    }
