...
class UIColor_HSVTest: XCTestCase {
    ...
    func testHSVInit() {
        assert(UIColor(hsv: HSV(hue: 0.0, saturation: 0.0, value: 100.0)), .white)
        assert(UIColor(hsv: HSV(hue: 0.0, saturation: 100.0, value: 100.0)), .red)
        assert(UIColor(hsv: HSV(hue: 120.0, saturation: 100.0, value: 100.0)), .green)
        assert(UIColor(hsv: HSV(hue: 240.0, saturation: 100.0, value: 100.0)), .blue)
        assert(UIColor(hsv: HSV(hue: 180.0, saturation: 100.0, value: 100.0)), .cyan)
        assert(UIColor(hsv: HSV(hue: 300.0, saturation: 100.0, value: 100.0)), .magenta)
        assert(UIColor(hsv: HSV(hue: 60.0, saturation: 100.0, value: 100.0)), .yellow)
        assert(UIColor(hsv: HSV(hue: 0.0, saturation: 0.0, value: 0.0)), .black)
        assert(UIColor(hsv: HSV(hue: 0.0, saturation: 0.0, value: 100.0/3.0)), .darkGray)
        assert(UIColor(hsv: HSV(hue: 0.0, saturation: 0.0, value: 50.0)), .gray)
        assert(UIColor(hsv: HSV(hue: 0.0, saturation: 0.0, value: 200.0/3.0)), .lightGray)
        assert(UIColor(hsv: HSV(hue: 0.0, saturation: 0.0, value: 0.0), alpha: 0.0), .clear)
    }
