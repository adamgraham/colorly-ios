...
public extension UIColor {
    ...
    /// The hue component of the color, in the range 0.0 to 1.0.
    ...
    /// The saturation component of the color, in the range 0.0 to 1.0.
    ...
    /// The brightness component of the color, in the range 0.0 to 1.0.
...
public extension UIColor {
    ...
    /// The white component of the color, in the range 0.0 to 1.0.
