...
public extension UIColor {
    ...
    public struct ColorWheel {
        ...
        public struct RYB {
            ...
            public static let vermilion = red + orange
            /// `#80ff00`, `ryb(128,255,0)`
            public static let amber = orange + yellow
            /// `#00ff80`, `ryb(0,255,128)`
            public static let chartreuse = yellow + green
            /// `#0080ff`, `ryb(0,128,255)`
            public static let teal = green + blue
            /// `#8000ff`, `ryb(128,0,255)`
            public static let violet = blue + purple
            /// `#ff0080`, `ryb(255,0,128)`
            public static let magenta = purple + red
