...
class UIColor_CIEUCSTest: XCTestCase {
    ...
    func testCIEUCSInit() {
        assert(UIColor(CIEUCS(u: 0.197840, v: 0.312224), luminance: 1.0000000), .white)
        ...
        assert(UIColor(CIEUCS(u: 0.000000, v: 0.000000), luminance: 0.0000000), .black)
        ...
        assert(UIColor(CIEUCS(u: 0.000000, v: 0.000000), luminance: 0.0000000, alpha: 0.0), .clear)
    }
